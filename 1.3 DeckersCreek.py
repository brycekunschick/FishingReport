...
usgs_data = usgs_data[['datetime', '160494_00065']]
usgs_data = usgs_data.rename(columns={'160494_00065': 'surface_level'})
...
surface_level = usgs_data.iloc[0]['surface_level']
...
Current Water Level: {surface_level:.2f} feet. Favorable if below 1.5 ft. This variable is the most important.
